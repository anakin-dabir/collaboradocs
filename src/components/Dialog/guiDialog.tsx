...
import { useGuiDialogStyles } from "../../themes/themes";
  ...
  return (
    ...
    >
      <Box className={dialogClasses.root}>
        <ModuleTopLeft
          className={clsx(dialogClasses.border, dialogClasses.top_left_border)}
        />
        <ModuleBottomLeft
          className={clsx(
            dialogClasses.border,
            dialogClasses.bottom_left_border
          )}
        />
        <ModuleBottomRight
          className={clsx(
            dialogClasses.border,
            dialogClasses.bottom_right_border
          )}
        />
        <ModuleTopRight
          className={clsx(dialogClasses.border, dialogClasses.top_right_border)}
        />
